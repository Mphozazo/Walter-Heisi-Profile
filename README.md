...
## 👨‍💻 About Me
 Senior Software Engineer with 30+ years of experience designing, modernising,
 and supporting enterprise backend systems across banking, insurance,
 government, and financial services.

 Specialised in Microsoft .NET, API engineering, system modernisation, and
 cloud-based architectures, with a strong focus on **reliability, performance,
 security, and production stability**.

 Proven track record in transforming legacy VB and Delphi systems into scalable
 .NET and microservice-based platforms. Comfortable operating at senior-to-lead
 level, owning systems end-to-end and mentoring engineers.
...
- ⚡ Legacy modernisation to .NET Core & microservices
...
<br/>
<ul>
  - RESTful API design (routing, versioning, caching)
  - gRPC high-performance services (foundational experience)
  - Domain-Driven Design (DDD)
  - Clean Architecture
  - Asynchronous programming & high-throughput APIs
  - Microservices patterns (CQRS, eventual consistency)
</ul>
</details>
